...
import { ArrowLeft, Heart, FileText, Search } from "lucide-react";
...
export default function SyllabusSemesterPage() {
    ...
    useEffect(() => {
        if (status === "unauthenticated" && semesterNum >= 3) {
            router.push(`/auth/signin?callbackUrl=/Syllabus/${semester}`);
        }
    ...
    const subjects = Object.entries(syllabusData[semesterKey] || {});
                ...
                <div className="container">
                    ...
                    <div className="flex items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/30">Syllabus</Badge>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-muted-foreground">
                            Select a subject to open the syllabus link.
                        </p>
                    </motion.div>
                    ...
                    <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {visibleSubjects.length > 0 ? (
                            visibleSubjects.map(([subject, link], index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Link
                                            href={`/Syllabus/${semesterNum}/${subject}`}
                                        ...
                                        >
                                            ...
                                            >
                                                <CardHeader className="pb-4 pr-14">
                                                    ...
                                                    <CardDescription>Open syllabus</CardDescription>
                                                </CardHeader>
                                        ...
                                        <Button
                                            ...
                                            variant="ghost"
                                            size="icon"
                                            onClick={() => toggleFavorite({ semester: semesterNum, subject, url: link })}
                            ...
                            >
                                ...
                                <p className="text-muted-foreground">
                                    {showFavoritesOnly
                                        ...
                                        : subjects.length === 0
                                            ? "No syllabus data available for this semester yet."
